...
//        setWillNotDraw(false);
    ...
    private void init()
    {
        View mRootView = inflate(getContext(), R.layout.view_transition, this);

        v_spread = mRootView.findViewById(R.id.v_spread);
        v_line = mRootView.findViewById(R.id.v_line);
        tv_sign_up = mRootView.findViewById(R.id.tv_sign_up);
        tv_success = mRootView.findViewById(R.id.tv_success);
    }
